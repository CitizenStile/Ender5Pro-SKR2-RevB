 ...
 */
#define HOTEND_IDLE_TIMEOUT // MODIFIED
...
#define USE_CONTROLLER_FAN // MODIFIED
  ...
  #define CONTROLLER_FAN_PIN FAN2_PIN           // Set a custom pin for the controller fan // MODIFIED
 ...
 */
#define E0_AUTO_FAN_PIN PB4 // MODIFIED - Hotend 1 pin
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME         // Display estimated time to completion // MODIFIED
  ...
  #define LONG_FILENAME_HOST_SUPPORT // MODIFIED
   ...
   */
  #define CONFIGURATION_EMBEDDING // MODIFIED
    #define NO_CONFIGURATION_EMBEDDING_WARNING // MODIFIED
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). // MODIFIED
  ...
  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping
    ...
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor // MODIFIED
  #endif
#endif
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS // MODIFIED
...
#define MEATPACK_ON_SERIAL_PORT_1 // MODIFIED
...
#define HOST_ACTION_COMMANDS // MODIFIED
  ...
  #define HOST_PAUSE_M76 // MODIFIED
  #define HOST_PROMPT_SUPPORT // MODIFIED
...
//
#define PINS_DEBUGGING // MODIFIED
